                                ...
                                <div class="user-checkout text-left">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   class="form-control" id="namaLengkap"
                            ...
                            <div class="col-lg-12">
                                <div class="proceed-checkout text-left">
                                    <ul>
                                        ...
                                        <li class="subtotal mt-3">Subtotal <span>${{ priceTotal }}.00</span></li>
                                        <li class="subtotal mt-3">Pajak <span>10%</span></li>
                                        <li class="subtotal mt-3">Total Biaya <span>${{ priceTotalWithTax }}.00</span></li>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            checkout(){
                ...
                let checkoutData = { 
                    ...
                    'transaction_total': this.priceTotalWithTax,
        ...
        computed: {
            ...
            priceTotalWithTax() {
                return this.priceTotal + this.priceWithTax;
            }
        }
    }
</script>
